<?php
define('C_REST_CLIENT_ID','local.6065faad333b62.66784339');//Application ID
define('C_REST_CLIENT_SECRET','Kdm6y8rsVCIP3By45w3bX0erAJnSkQ6BuqgsWwQbZxbM5KwPKG');//Application key
// or
